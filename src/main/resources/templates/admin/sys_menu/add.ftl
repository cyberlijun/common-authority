...
<html>
    ...
    <body>
        <div class="page-container">
            <form action="${adminPath}/menu/add.json" class="form form-horizontal" method="post">
                <#if parent.id != 1>
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="${parent.menuName!''}" disabled>
                        </div>
                    </div>
                </#if>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="menuName" name="menuName" placeholder="菜单名称">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="menuUrl" name="menuUrl" placeholder="菜单URL">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="permission" name="permission" placeholder="权限标识">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <div class="skin-minimal">
                            <div class="radio-box">
                                <input id="display_yes" type="radio" name="display" value="1" checked>
                                <label for="display_yes">是</label>
                            </div>
                            <div class="radio-box">
                                <input id="display_no" type="radio" value="0" name="display">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="sort" name="sort" placeholder="排序">
                    </div>
                </div>
                <div class="row cl">
