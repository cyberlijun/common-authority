...
<html>
    ...
    <body>
        <div class="page-container">
            <form action="${adminPath}/area/add.json" class="form form-horizontal" method="post">
                <#if parent.id != 1>
                    <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="code" name="code" placeholder="区域编码">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="name" name="name" placeholder="区域名称">
                    </div>
                </div>
                <div class="row cl">
