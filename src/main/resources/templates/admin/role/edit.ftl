...
<html>
    <head>
        ...
        <title>${property("systemInfo.name")}-编辑角色</title>
    </head>
    <body>
            ...
            <form action="${adminPath}/role/update.json" class="form form-horizontal" method="post">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input id="orgName" name="orgName" class="input-text" style="cursor: pointer;" type="text" value="${role.org.name!''}" readonly placeholder="所属机构">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="name" name="name" value="${role.name!''}" placeholder="角色名称">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
        ...
        $().ready(function (e) {
            ...
            menuTree.checkNode(menuTree.getNodeByParam('id', ${menu.id}), true, false);
            </#list>
                    ...
                    name: {
                        ...
                        remote: {
                            ...
                            data: {
                                ...
                                oldOrgId: function () { return role.org.id; },
