...
<html>
    ...
    <body>
        <div class="page-container">
            <form action="${adminPath}/org/update.json" class="form form-horizontal" method="post">
            <#if org.parent.id != 1>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="${org.parent.name!''}" disabled>
                    </div>
                </div>
            </#if>
            <#if areas?size gt 0>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <span class="btn-upload form-group">
                            <input id="areaName" class="input-text upload-url" type="text"<#if org.area??> value="${org.area.name!''}"</#if> readonly placeholder="所属区域">
                            <input id="areaId" name="area.id" type="hidden"<#if org.area??> value="${org.area.id}"</#if>>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="code" name="code" value="${org.code!''}" placeholder="机构编码">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="name" name="name" value="${org.name!''}" placeholder="机构名称">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="address" name="address" value="${org.address!''}" placeholder="联系地址">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="zipCode" name="zipCode" value="${org.zipCode!''}" placeholder="邮编">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="master" name="master" value="${org.master!''}" placeholder="负责人">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="phone" name="phone" value="${org.phone!''}" placeholder="联系电话">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="fax" name="fax" value="${org.fax!''}" placeholder="传真">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" id="email" name="email" value="${org.email!''}" placeholder="邮箱">
                    </div>
                </div>
                <div class="row cl">
                    ...
                    rules: {
                        code: {
                            ...
                            remote: {
                                ...
                                cache: false,
                                data: {
                                    oldCode: function () { return '${org.code!''}'; },
