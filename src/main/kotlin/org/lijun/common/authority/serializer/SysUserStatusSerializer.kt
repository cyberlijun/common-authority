...
/**
 * JsonSerializer - SysUserStatusSerializer
 *
 * @author lijun
 * @constructor
 */
class SysUserStatusSerializer : JsonSerializer<SysUser.Status>() {

    override fun serialize(value: SysUser.Status?, jgen: JsonGenerator?, provider: SerializerProvider?) {
